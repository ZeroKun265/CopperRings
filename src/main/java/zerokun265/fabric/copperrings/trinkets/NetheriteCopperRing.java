...
public class NetheriteCopperRing extends TrinketItem {
    ...
    public void tick(ItemStack stack, SlotReference slot, LivingEntity entity) {
        ...
        entity.addStatusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 10, 1));
    }

    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.copperrings.netherite_copper_ring.tooltip"));
